...
String name_comp = "Nepal Jewellers";
...
void show_price_update_nep()
{
  ...
  dmd.drawString(36,0, "[");
  dmd.drawString(34,8, tgold);

  dmd.drawString(98,0, "\\");
  dmd.drawString(98,8, fgold);
  
  dmd.drawString(70, 0, "_");
  dmd.drawString(71, 8, silver);
...
void show_price_update_eng()
{
   String tgold = eeprom_read(offset_addr);
    ...
    Serial.println(silver);
    dmd.selectFont(FONTNep);
  dmd.drawString(33,0, "TGold");
  dmd.selectFont(FONTEng);
  dmd.drawString(33,8, tgold);

  dmd.selectFont(FONTNep);
  dmd.drawString(97,0, "FGold");
  dmd.selectFont(FONTEng);
  dmd.drawString(97,8, fgold);
  
  dmd.selectFont(FONTNep);
  dmd.drawString(67, 0, "a");
  dmd.selectFont(FONTEng);
  dmd.drawString(71, 8, silver);
