...
void display_company()
{
  ...
  draw_box_with_gap(11,2,81,2);
  draw_box_with_gap(81,2,81,12);
  draw_box_with_gap(81,12,11,12);
  
  show_price_update_eng();

  draw_box_without_gap(10,13,10,1);
  draw_box_without_gap(10,1,82,1);
  draw_box_without_gap(82,1,82,13);
  draw_box_without_gap(82,13,10,13);
