...
const char* ssidAP = "Wintercamp";
const char* passwordAP = "Wintercamp";
...
void setup()
{
    ...
    server.on("/RFR_EY", handleQueryArgs);
...
void loop(){
 ...
 displayConstMessage("ARUNIMA EDUCATIONAL FOUNDATION (AEF)");
 ...
 for (int i = 0; i < 5; i++)
  {
     dmd.drawString(48, 4, "WINTER CAMP");
     show_date_time();
  }
