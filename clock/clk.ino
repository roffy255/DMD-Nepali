...
const char *ssidAP = "digitalclock";
const char *passwordAP = "MSSCHOOLFRONT";
const char *ota_hostname = "frontota";
...
void greeting()
{
    ...
    if (timing >= 12 & timing < 17)
    {
        ...
        delay_engine(3000);
        dmd.clearScreen();
        display_message("Good Afternoon Roshan! Hope you take launch on time");
        // motion.ASUN_2(64, -8);
    }
    else if (timing >= 17 & timing < 20)
    {
        // mid_display_engfont(4, 32, greeting_array[2], 192);
        // motion.ASUN_2(0, 0);
        for (int i = 16; i > 0; i--)
        {
            dmd.clearScreen();
        ...
        delay_engine(3000);
        dmd.clearScreen();
        display_message("Good Evening Roshan! Don't forget your workout");
    }
    else if ((timing >= 20 & timing <= 23) || (timing < 4))
    {
        // mid_display_engfont(4, 32, greeting_array[3], 192);
        // motion.moon(165, 0);
        for (int i = 16; i > 0; i--)
        {
            dmd.clearScreen();
        ...
        dmd.setPixel(0, 0, GRAPHICS_ON);
        dmd.setPixel(0, 0, GRAPHICS_ON);
        dmd.setPixel(14, 0, GRAPHICS_ON);
        dmd.setPixel(7, 3, GRAPHICS_ON);
        dmd.setPixel(10, 3, GRAPHICS_ON);
        dmd.setPixel(24, 3, GRAPHICS_ON);
        dmd.setPixel(29, 3, GRAPHICS_ON);
        dmd.setPixel(30, 8, GRAPHICS_ON);
        // dmd.setPixel(19, 8, GRAPHICS_ON);
        dmd.setPixel(28, 8, GRAPHICS_ON);
        // dmd.setPixel(19, 8, GRAPHICS_ON);
        dmd.setPixel(1, 10, GRAPHICS_ON);
        dmd.setPixel(6, 10, GRAPHICS_ON);
        dmd.setPixel(22, 10, GRAPHICS_ON);
        dmd.setPixel(27, 12, GRAPHICS_ON);
        dmd.setPixel(28, 13, GRAPHICS_ON);
        dmd.setPixel(15, 13, GRAPHICS_ON);
        dmd.setPixel(12, 13, GRAPHICS_ON);
        dmd.setPixel(5, 15, GRAPHICS_ON);
        dmd.setPixel(6, 15, GRAPHICS_ON);
        dmd.setPixel(10, 15, GRAPHICS_ON);
        dmd.setPixel(15, 15, GRAPHICS_ON);
        dmd.setPixel(18, 15, GRAPHICS_ON);
        dmd.setPixel(16, 16, GRAPHICS_ON);
        dmd.setPixel(11, 16, GRAPHICS_ON);

        delay_engine(3000);
        dmd.clearScreen();
        display_message("Good Night Roshan! Have a sweet dream");
    }
    else if (timing >= 4 & timing < 11)
    {
        // mid_display_engfont(4, 32, greeting_array[0], 192);
        // motion.sun_2(165, 0);
        for (int i = 16; i > 0; i--)
        {
            dmd.clearScreen();
        ...
        delay_engine(3000);
        dmd.clearScreen();
        display_message("Good Morning Roshan! Wake up");
    }
}
...
void show_temp()
{
    dmd.drawString(0, 4, get_Temp());
    dmd.drawString(27, 4, "C");
...
void loop()
{
    ...
    {
        //        displayBold("MAHAN SIDDHARTHA HIGH SCHOOL (+2)");
        //        dmd.selectFont(FONTEng);
        //        mid_display_engfont(4, 0, "MAHAN SIDDHARTHA HIGH SCHOOL", 224);
        //        delay_engine(5000);
