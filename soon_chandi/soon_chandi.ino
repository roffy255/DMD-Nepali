...
String get_time(String seperator){
  ...
  if (Clock.getSecond() < 10)
    ...
    Time = valuee_hour + ":" + valuee_minute + ":" + valuee_second ;
...
void show_price_update_nep()
{
  ...
  dmd.drawString(6,16, "]");
  dmd.drawString(0,24, fgold);
  
  dmd.drawString(36, 16, "_");
  dmd.drawString(37, 24, silver);
...
void show_price_update_eng()
{
  ...
  dmd.drawString(3,16, "Gold");
  dmd.drawString(0,24, fgold);
  
  dmd.drawString(32, 16, "Silver");
  dmd.drawString(38, 24, silver);
